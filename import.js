...
// --- !!! UPDATED PATH - Now uses relative path from project root !!! ---
// This path points to the 'cves' folder which contains the year folders (2025, 2024, etc.).
// The cve-data directory should be inside mitre-cve-database/
const DATA_DIR = path.join(__dirname, 'mitre-cve-database', 'cve-data', 'mitre', 'cves');
